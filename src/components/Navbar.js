...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center w-full
     h-20 px-4 text-white bg-slate-900 fixed border-b-2 border-gray-500'>
        <div>
            <Link to='home'>
               <h1 className='ml-2 text-4xl font-signature cursor-pointer'>Madan </h1>
            </Link>
        </div>
        ...
        { nav && (
          ...
          top-0 left-0 w-full h-screen bg-gradient-to-b from-slate-900 to-slate-600
           text-gray-500 '>
